...
import com.example.naidich.tom.tomsprojectapplication.core.services.AuthenticationService;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try{
                ApiResult apiResult = authenticationService.authenticateUser(mEmail,mPassword);

                if(!apiResult.isSuccess()){
                    LogHelper.logWarning(apiResult.getError());
                    return false;
                }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                startActivity(IntentFactoryHelper.getIntent(LoginActivity.this, IntentFactoryHelper.IntentType.Main));
                finish();
